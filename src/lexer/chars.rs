...
impl<'a> Lexer<'a> {
    ...
    pub(super) fn tokenize_identifier(&mut self) -> Result<Token<'a>, Error> {
        ...
        let kind = match identifier {
            ...
            "URange8" => TokenKind::URange8,
            "URange16" => TokenKind::URange16,
            "URange32" => TokenKind::URange32,
            "URange64" => TokenKind::URange64,
            "URange128" => TokenKind::URange128,
            "Range8" => TokenKind::Range8,
            "Range16" => TokenKind::Range16,
            "Range32" => TokenKind::Range32,
            "Range64" => TokenKind::Range64,
            "Range128" => TokenKind::Range128,
